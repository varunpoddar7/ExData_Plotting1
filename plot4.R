...
with(subPowerData, plot(x=datetime, y=Global_active_power, type="l", ylab = "Global Active Power", xlab=""))
with(subPowerData, plot(x=datetime, y=Voltage, type="l", ylab = "Voltage", xlab="datetime"))
with(subPowerData, {
  plot(x=datetime, y=Sub_metering_1, type="l", xlab = "", ylab="Energy sub metering", main="")
  lines(x=datetime, y=Sub_metering_2, col="red")
  lines(x=datetime, y=Sub_metering_3, col="blue")
  legend("topright", lty=1, col=c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), bty="n")
})
with(subPowerData, plot(x=datetime, y=Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()
